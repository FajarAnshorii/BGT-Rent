      ...
      <div className="container-custom relative z-10 py-20 md:py-28">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            {/* Subheadline */}
            <p className="text-sm sm:text-lg md:text-xl text-gray-600 mb-6 sm:mb-8 max-w-xl mx-auto lg:mx-0">
            ...
            {/* Highlights */}
            <div className="flex flex-wrap justify-center lg:justify-start gap-1.5 sm:gap-3 mb-6 sm:mb-8">
              {HIGHLIGHTS.map((highlight, index) => (
                <div
                  key={index}
                  className="flex items-center gap-1.5 px-2.5 py-1 bg-white rounded-full text-xs sm:text-sm text-gray-700 shadow-sm border border-gray-100"
                >
            ...
            <div className="flex flex-col sm:flex-row gap-2.5 sm:gap-4 justify-center lg:justify-start">
              ...
              <a
                ...
                className="btn-secondary text-sm sm:text-lg px-5 sm:px-8 py-2.5 sm:py-4"
              >
                Lihat Layanan
